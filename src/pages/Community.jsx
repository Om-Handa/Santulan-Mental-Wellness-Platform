    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="container mx-auto px-6 py-8 max-w-6xl flex justify-center flex-col items-center">
        <div className="text-center mb-8">
          <h1 className="text-5xl font-bold text-blue-600 mb-2">Peer Chat Forum</h1>
          <p className="text-gray-500 mb-6 text-xl">Connect with others on your wellness journey</p>
          ...
          <div className="max-w-md mx-auto relative">
            ...
            <input type="text" placeholder="Search for peers or groups" value={searchQuery} onChange={(e) => setSearchQuery(e.target.value)} className="w-full pl-10 pr-4 py-3 border border-gray-200 rounded-lg bg-white focus:outline-none focus:ring-2 focus:ring-blue-500"
            />
          </div>
        </div>

        <div className="mb-8 w-11/12">
          <div className="flex justify-center items-center space-x-8 border-b border-gray-200 bg-gray-100 rounded-xl">
            {[
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-xl border">
              <div className="space-y-0">
                {chats.map((chat) => (
                  <div key={chat.id} className="p-4 border-b last:border-b-0 hover:bg-gray-100/50 cursor-pointer transition-colors">
              ...
              <div className="p-8 text-center border-t">
                ...
                <p className="text-gray-500 mb-4">Connect with peers or create a support group</p>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-xl border p-6 w-11/12">
              <div className="flex items-center space-x-2 mb-4">
